...
-- =============================================
-- Author:		desa21
-- Create date: 12 diciembre 2019
-- Description:	Inicializacion del Sand Box, se una en la desktopApp ConfiguracionRespuestas
-- =============================================
CREATE PROCEDURE InicializaSandBox
AS
BEGIN
	IF NOT EXISTS (
	SELECT  schema_name
